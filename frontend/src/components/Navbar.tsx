    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#FAF8F5]/95 backdrop-blur-md border-t border-[#E6E0D4] px-4 py-2 pb-5">
      <div className="max-w-md mx-auto flex items-center justify-around">
        ...
        >
          ...
          <span className="text-[11px] leading-tight">Añadir</span>
          <span className="text-[9px] text-[#A0988C] font-normal leading-none">Add</span>
        </button>
        ...
        >
          ...
          <span className="text-[11px] leading-tight">Repasar</span>
          <span className="text-[9px] text-[#A0988C] font-normal leading-none">Review</span>
        </button>
        ...
        >
          ...
          <span className="text-[11px] leading-tight">Glosario</span>
          <span className="text-[9px] text-[#A0988C] font-normal leading-none">Glossary</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] text-[#A0988C] font-normal leading-none">Settings</span>
        </button>
      </div>
    </nav>
  );
